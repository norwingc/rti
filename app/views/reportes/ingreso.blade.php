...
<section class="content">
	@include('includes.reporte.primer_reporte')
	@include('includes.reporte.segundo_reporte')
</section>
...
@section('js')
	@include('includes.reporte.__script_primer_reporte')
	@include('includes.reporte.__script_segundo_reporte')
@stop	